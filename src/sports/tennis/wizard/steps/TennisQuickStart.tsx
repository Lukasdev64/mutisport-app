 ...
 * Tennis Quick Start
 *
 * One-page tournament creation for Tennis.
 * Everything on a single screen - play in less than a minute.
 */
...
export function TennisQuickStart() {
      ...
      <div className="max-w-4xl mx-auto py-6 px-4">
        ...
        <div className="space-y-6">
                ...
                >
                  <div className="relative mb-4">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 bg-slate-800 border border-white/10 rounded-lg text-white text-sm placeholder:text-slate-500 focus:outline-none focus:border-emerald-500"
                    />
                  </div>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "p-4 rounded-xl border text-center transition-all",
                      isSelected
                        ? `${option.bg} ${option.border} ring-2 ring-emerald-500`
                        : isCompatible
                          ? "bg-slate-800/50 border-white/10 hover:border-white/20"
            ...
            <form onSubmit={handleAddPlayer} className="flex gap-3 mb-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-slate-800 border border-white/10 rounded-xl text-white placeholder:text-slate-500 focus:outline-none focus:border-emerald-500"
                />
              </div>
              <Button
                type="submit"
          ...
          <div className="text-center">
            <button
              onClick={() => navigate('/tournaments/new/tennis')}
              className="text-slate-500 hover:text-white text-sm transition-colors"
            >
              Retour au wizard complet
            </button>
          </div>
        </div>
      </div>
